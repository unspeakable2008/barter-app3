...
export const AppTabNavigator = createBottomTabNavigator({
     ...
     DonateBooks:{screen:BookDonateScreen,navigationOptions:{tabBarIcon:<Image source = {require("../assets/bookDonate.png")}style = {{width:20,height:20}}></Image>,tabBarLabel:"DonateBooks "}},
